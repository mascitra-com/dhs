...
class Users extends Auth {
	...
	private function makeFolder($id) {
		if (!is_dir('assets/file/temp-' . $id)) {
			@mkdir('assets/file/temp-' . $id);
		}
	}
	...
	public function removeFolder($id) {
		if (is_dir('assets/file/temp-' . $id)) {
			array_map('unlink', glob('assets/file/temp-' . $id . '/*.*'));
			return rmdir('assets/file/temp-' . $id);
		} else {
			return TRUE;
		}
	}
