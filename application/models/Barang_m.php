...
class barang_m extends MY_Model {
	...
	public function get_all_data($filter = null) {
		$this->db->select("b.id as id, b.kode_kategori as kode_kategori, b.nama as nama, merk, tipe, spesifikasi, gambar, k.nama as kategori, hargaPasar, hargashsb, keterangan, createdAt, updateAt, u.first_name, u.last_name");
