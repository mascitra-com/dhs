    ...
    <div class="col-md-8">
        <div class="card">
            <div class="content">
                <div class="row">
                    <div class="col-md-9">
                        <a class="btn btn-warning btn-fill" href="<?= site_url('katalog/add') ?>"><i class="fa fa-plus"></i> Tambah Data</a>
                        <a class="btn btn-success btn-fill" href="<?= site_url('export/katalog') ?>" target="_blank"><i class="fa fa-download"></i> Export Excel</a>
                        <a class="btn btn-danger btn-fill" href="<?= site_url('export/katalog/pdf') ?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
                ...
                <table class="table table-hover">
                    <tbody>
                        <?php foreach ($barang as $brg): ?>
                            <tr id="brg<?= $brg->id ?>">
                                <td width="20%">
                                    <a href="<?= site_url('katalog/detail/' . $brg->id) ?>">
                                ...
                                <td>
                                    ...
                                    <h5>
                                    <a href="<?= site_url('katalog/detail/' . $brg->id) ?>"><b class="text-muted"><?= $brg->kode_kategori?></b></a>
                                    </h5>
                                    <h4>
                                ...
                                <td width="30%">
                                    <p>
                                        <i class="fa fa-tag fa-fw"></i> Harga Pasar: Rp.<?= number_format($brg->hargaPasar, '0', '', '.') ?>,-</p>
                                        <p>
                                            <i class="fa fa-tags fa-fw"></i> Harga SHSB: Rp.<?= number_format($brg->hargashsb, '0', '', '.') ?>,-</p>
                                            <p>
                                                <i class="fa fa-paper-plane fa-fw"></i> Penyedia: <?= substr($brg->keterangan, 0, 14) ?></p>
                                                <p>
                                                    <i class="fa fa-calendar fa-fw"></i> Terakhir update : <?php echo mdate('%d-%m-%Y', strtotime(str_replace('-', '/', $brg->updateAt))); ?>
                                                </p>
                                                <p>
                                                    <i class="fa fa-user fa-fw"></i>Updated By: <?= $brg->first_name ?> <?= $brg->last_name ?>
                                                </p>
                                            </td>
