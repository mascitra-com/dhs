<div class="row">
    <div class="col-md-2">
        ...
        <div class="panel list-group">
            <?php for ($j = 1; $j <= 15; $j++): ?>
                <!-- list & sublist -->
                <button class="list-group-item" data-toggle="collapse" data-target="#sm<?=$j?>">KATEGORI-<?=$j?></button>
                <div id="sm<?=$j?>" class="sublinks collapse">
                    <a class="list-group-item small">inbox</a>
                    <a class="list-group-item small">sent</a>
                </div>
                <!-- batas list & sublist -->
            <?php endfor; ?>
        </div>
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="content">
                <div class="row">
                    <div class="col-md-6">
                        <a class="btn btn-warning btn-fill" href="<?=site_url('katalog/form')?>"><i class="fa fa-plus"></i> Tambah Data</a>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="text" class="form-control" id="ip-nama" value="<?= (isset($filter['nama'])) ? $filter['nama'] : '' ?>" placeholder="Nama"></div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="text" class="form-control" id="ip-merk" value="<?= (isset($filter['merk'])) ? $filter['merk'] : '' ?>" placeholder="Merk">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="text" class="form-control" id="ip-tipe" value="<?= (isset($filter['tipe'])) ? $filter['tipe'] : '' ?>" placeholder="Tipe">
                            </div>
                        </div>
                        <div class="col-md-5">
                            ...
                            <?php foreach ($barang as $brg): ?>
                                <tr id="brg<?= $brg->id ?>">
                                    ...
                                    <td>
                                        ...
                                        <h5>
                                            <a href="<?= site_url('katalog/detail/' . $brg->id) ?>"><b class="text-muted"><?=$brg->id_kategori.'.'.$brg->id?></b></a>
                                        </h5>
                                        <h4>
                                    ...
                                    <td width="25%">
                                        ...
                                        <p><i class="fa fa-calendar fa-fw"></i> Harga Pada Tanggal: <?php echo mdate('%d-%m-%Y', strtotime(str_replace('-', '/', $brg->createdAt))); ?></p>
                                    </td>
